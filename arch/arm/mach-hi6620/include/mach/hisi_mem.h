...
extern unsigned long hisi_reserved_codec_fix_size;
extern unsigned long PLAT_MEM_RESERVED_SIZE_NEW;
extern unsigned long HISI_FRAME_BUFFER_SIZE;
#define  CODEC_FIX_SIZE    hisi_reserved_codec_fix_size//((PAGE_ALIGN(SZ_4M+SZ_8M+SZ_8M)))
#define  CODEC_DEC_SIZE    0
#define  GRALLOC_FIX_SIZE  0// (( PAGE_ALIGN(SZ_16M+SZ_4M+SZ_1M)))
#define  GRALLOC_DEC_SIZE  0//(( PAGE_ALIGN(SZ_16M+SZ_4M+SZ_1M)))
