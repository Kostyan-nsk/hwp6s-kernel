...
static enum lowlayer_func sd_func_lowpower_sophia_clg_vb[] = {FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0,  -INVALID,};
static enum pull_updown sd_pullud_lowpower_sophia_clg_vb[] = {NOPULL, PULLUP, PULLUP, PULLUP, PULLUP, PULLUP,  -INVALID,};
