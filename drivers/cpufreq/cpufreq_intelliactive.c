...
static unsigned int hispeed_freq = 1196000;
...
static unsigned int sync_freq = 624000;
static unsigned int up_threshold_any_cpu_freq = 1795000;

static int two_phase_freq_array[NR_CPUS] = {[0 ... NR_CPUS-1] = 1196000} ;
