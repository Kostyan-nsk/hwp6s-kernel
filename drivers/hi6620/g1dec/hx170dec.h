...
#define HX170DEC_IOC_WAITFORDEC _IO(HX170DEC_IOC_MAGIC,  7)
#define HX170DEC_IOC_WAITFORPP  _IO(HX170DEC_IOC_MAGIC,  8)
#define HX170DEC_IOC_CLOCK_ON   _IO(HX170DEC_IOC_MAGIC,  9)
#define HX170DEC_IOC_CLOCK_OFF  _IO(HX170DEC_IOC_MAGIC,  10)
