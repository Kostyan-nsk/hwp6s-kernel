...
#define MEMALLOC_IOCXGETSTATICBUFFER      _IOWR(MEMALLOC_IOC_MAGIC,  3, unsigned long)
#define MEMALLOC_IOCXFREESTATICBUFFER     _IOW(MEMALLOC_IOC_MAGIC,  4, unsigned long)
