...
static struct partition partitions[] = {
	...
	{ "system", 1536*1024 }, /* 26 system 1536M */
	{ "cust", 512*1024 }, /* 27 customer 512M */
#if defined(CONFIG_PRODUCT_ADD_APLOG)
        { "aplog", 128*1024 }, /* aplog 128M */
#endif
#if defined(CONFIG_NOT_ADD_3RDMODEMNV)
#if defined(CONFIG_PRODUCT_ADD_APLOG)
        { "userdata", 4160*1024 }, /* 28 userdata 4160M */
#else
        { "userdata", 4288*1024 }, /* 28 userdata 4288M */
#endif
#else
#if defined(CONFIG_PRODUCT_ADD_APLOG)
        { "userdata", 4112*1024 }, /* 28 userdata 4G+(reset for userdata) */
#else
