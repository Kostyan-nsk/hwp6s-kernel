...
#define LPHY_MAILBOX_LHPA_DOWN_SIZE                 (0x00001C00UL)  /*change size of dl mbx from 6K to 7K*/		/*6k字节，PS下行邮箱大小*/
...
#define LPHY_RSVD_DATA_BUF_SIZE                     (0x00000000UL)  /*change size of dl mbx from 1K to 0K*/		/*1k字节，TDS COMM BUF数据区大小*/
