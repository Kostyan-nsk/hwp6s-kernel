...
enum RRC_NAS_MS_MODE_ENUM
{
    RRC_NAS_MS_MODE_PS_CS,
    RRC_NAS_MS_MODE_PS_ONLY,
    RRC_NAS_MS_MODE_CS_ONLY,
    RRC_NAS_MS_MODE_NULL,
    RRC_NAS_MS_MODE_BUTT
};
typedef VOS_UINT8 RRC_NAS_MS_MODE_ENUM_UINT8;

typedef struct
{
    /* PS_TRUE:允许注册，PS_FALSE:不允许，Detach */
    VOS_UINT8                           ucPsAttachAllow;
    RRC_NAS_MS_MODE_ENUM_UINT8          enMsMode;
    VOS_UINT8                           aucReserved[2];
}MM_MS_SYS_CFG_INFO_STRU;
/*****************************************************************************
  8 UNION定义
*****************************************************************************/
...
extern VOS_VOID MM_GetMsSysCfgInfo(MM_MS_SYS_CFG_INFO_STRU *pstMsSysCfgInfo);
