...
enum LRRC_CMMCA_MSG_TYPE_ENUM
{
    ...
    /* LRRC-> CMMCA CDMA MSG:  */
	LRRC_CMMCA_CDMA_MSG_IRAT_SET_PRIINFO_REQ			    = (LRRC_CMMCA_MSG_HDR + 0x03),		/* _H2ASN_MsgChoice LRRC_CMMCA_CDMA_MSG_IRAT_SET_PRIINFO_STRU */
	...
	/* CMMCA->LRRC CDMA MSG: */
	CMMCA_LRRC_CDMA_MSG_IRAT_SET_PRIINFO_REQ				= (CMMCA_LRRC_MSG_HDR + 0x03),		/* _H2ASN_MsgChoice CMMCA_LRRC_CDMA_MSG_IRAT_SET_PRIINFO_STRU */
