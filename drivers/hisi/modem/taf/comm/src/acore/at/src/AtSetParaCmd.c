...
/*****************************************************************************
 ...
 Description    : ascii形式的unicode到2个字节unicode的转换
 Input          : pData --- 字符串
                  pLen  --- 长度地址
 Output         :
 Return Value   : AT_XXX  --- ATC返回码
...
)
{
    ...
    /* Added by f62575 for DTS20140304, 2014-03-04,Begin */
    PS_MEM_SET(stRcvPath.aucReserve1, 0, sizeof(stRcvPath.aucReserve1));
    /* Added by f62575 for DTS20140304, 2014-03-04,End   */
