...
#define PLATFORM_DEVICE_LCD_NAME   "mipi_cmi_OTM1282A"
...
static bool is_cmi_otm1282a(void) 
{
...
static int __init lcd_device_cmi_otm1282a_init(void)
{
	int ret = 0;
	if (is_cmi_otm1282a()) {
...
arch_initcall(lcd_device_cmi_otm1282a_init);
