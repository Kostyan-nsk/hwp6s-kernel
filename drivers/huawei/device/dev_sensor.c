...
#endif
#include"../drivers/sensor/accelerometer/gs_rohm_kx023.h"
...
static struct kx023_platform_data kx023_gs_platform_data ={
	.axis_map_x = 0,
	.axis_map_y = 1,
	.axis_map_z = 2,
...
static struct i2c_board_info  v9r1_i2c_3_boardinfo_h30l[] = {
...
//add three_color_led drivered by tca6507
	...
	{
		I2C_BOARD_INFO("Rohm_accel", 0x1E),
		.platform_data = &kx023_gs_platform_data,
...
{
	unsigned int sensor_type = SENSOR_TYPE;
	sensor_type=sensor_type = hsad_sensor_get_type();
	sensor_layout_init();
	if(E_SENSOR_TYPE_H30L==sensor_type)
	{
		i2c_register_board_info(3, v9r1_i2c_3_boardinfo_h30l, ARRAY_SIZE(v9r1_i2c_3_boardinfo_h30l));
	}
	else
	{
