...
static int __init lsm330_gyr_i2c_init(void)
{
	pr_info("%s: gyroscope driver init\n", LSM330_GYR_DEV_NAME);
	return i2c_add_driver(&lsm330_gyr_i2c_driver);
}

static void __exit lsm330_gyr_i2c_exit(void)
{
	i2c_del_driver(&lsm330_gyr_i2c_driver);
}

module_init(lsm330_gyr_i2c_init);
module_exit(lsm330_gyr_i2c_exit);
