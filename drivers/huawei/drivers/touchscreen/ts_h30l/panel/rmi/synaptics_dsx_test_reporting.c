...
static short FullRawMaxCap = 3854;
static short FullRawMinCap = 0; //875->100
...
static short HighResistanceUpperLimit[3] = {450, 450, -544};
static short HighResistanceLowerLimit[3] = {0, 0, -2500}; //-1294->-2500
