...
config_pair  hw_EDGE_PLUS_UG_VA_configs [] = {
    ...
    {"product/name", (const unsigned int)(unsigned int*)"EDGE_PLUS_UG_VA", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"sensor/compass_layout", (unsigned int)7, E_CONFIG_DATA_TYPE_INT },
...
struct board_id_general_struct config_common_EDGE_PLUS_UG_VA= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_EDGE_PLUS_UG_VA,
 .data_array={.config_pair_ptr=hw_EDGE_PLUS_UG_VA_configs},
 .list={NULL,NULL},
};
