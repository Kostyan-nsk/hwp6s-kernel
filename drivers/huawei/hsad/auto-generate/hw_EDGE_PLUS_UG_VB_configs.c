...
config_pair  hw_EDGE_PLUS_UG_VB_configs [] = {
    ...
    {"board/board_name", (const unsigned int)(unsigned int*)"EDGE_PLUS_UG_VB", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"flash/lm3642", (unsigned int)1, E_CONFIG_DATA_TYPE_INT },
...
struct board_id_general_struct config_common_EDGE_PLUS_UG_VB= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_EDGE_PLUS_UG_VB,
 .data_array={.config_pair_ptr=hw_EDGE_PLUS_UG_VB_configs},
 .list={NULL,NULL},
};
