...
config_pair  hw_EDGE_PLUS_UG_VC_configs [] = {
    ...
    {"board/board_name", (const unsigned int)(unsigned int*)"EDGE_PLUS_UG_VC", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"memory_config/fb", (unsigned int)10800, E_CONFIG_DATA_TYPE_INT },
    ...
    {"product/name", (const unsigned int)(unsigned int*)"EDGE_PLUS_UG_VC", E_CONFIG_DATA_TYPE_STRING },
...
struct board_id_general_struct config_common_EDGE_PLUS_UG_VC= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_EDGE_PLUS_UG_VC,
 .data_array={.config_pair_ptr=hw_EDGE_PLUS_UG_VC_configs},
 .list={NULL,NULL},
};
