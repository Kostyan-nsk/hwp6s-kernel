...
config_pair  hw_H30_L01_VA_configs [] = {
    {"apds/apds_type", (unsigned int)9, E_CONFIG_DATA_TYPE_INT },
    {"atmel/slave_address", (unsigned int)51, E_CONFIG_DATA_TYPE_INT },
    {"audio/aud_para", (const unsigned int)(unsigned int*)"HONORTL", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"audio/spk_pa", (const unsigned int)(unsigned int*)"CLASSD", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"board/board_name", (const unsigned int)(unsigned int*)"H30_L01_VA", E_CONFIG_DATA_TYPE_STRING },
    {"board/type", (unsigned int)1, E_CONFIG_DATA_TYPE_INT },
    {"camera/OV5648FX", (unsigned int)1, E_CONFIG_DATA_TYPE_INT },
    {"camera/OV8858", (unsigned int)1, E_CONFIG_DATA_TYPE_INT },
    {"camera/S5K4E1GX", (unsigned int)1, E_CONFIG_DATA_TYPE_INT },
    {"camera/SONYIMX219", (unsigned int)1, E_CONFIG_DATA_TYPE_INT },
    {"camera/faceIgnoreCount", (unsigned int)9, E_CONFIG_DATA_TYPE_INT },
    {"camera/h30lCamHardwareUnique", (unsigned int)1, E_CONFIG_DATA_TYPE_INT },
    ...
    {"camera/primary_sensor_raw_h", (unsigned int)2448, E_CONFIG_DATA_TYPE_INT },
    {"camera/primary_sensor_raw_w", (unsigned int)3264, E_CONFIG_DATA_TYPE_INT },
    ...
    {"gas_gauge/low_power_int", (unsigned int)3, E_CONFIG_DATA_TYPE_INT },
    {"gas_gauge/r_pcb", (unsigned int)65, E_CONFIG_DATA_TYPE_INT },
    ...
    {"lcd/devices", (const unsigned int)(unsigned int*)"mipi_cmi_OTM1282A", E_CONFIG_DATA_TYPE_STRING },
    {"lcd/esd_check_type", (unsigned int)4, E_CONFIG_DATA_TYPE_INT },
    ...
    {"memory_config/gralloc", (unsigned int)111616, E_CONFIG_DATA_TYPE_INT },
    {"memory_config/overlay", (unsigned int)58368, E_CONFIG_DATA_TYPE_INT },
    {"memory_config/ram", (unsigned int)64, E_CONFIG_DATA_TYPE_INT },
    {"memory_config/vpp", (unsigned int)0, E_CONFIG_DATA_TYPE_INT },
    ...
    {"product/name", (const unsigned int)(unsigned int*)"H30_L01_VA", E_CONFIG_DATA_TYPE_STRING },
    {"product/product_name", (const unsigned int)(unsigned int*)"H30_L01", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"sensor/compass_layout", (unsigned int)6, E_CONFIG_DATA_TYPE_INT },
    ...
    {"touchscreen/product", (const unsigned int)(unsigned int*)"h30l", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"usb/eye_pattern", (unsigned int)0x704334ea, E_CONFIG_DATA_TYPE_INT },
    ...
    {"video/vpp_enable", (unsigned int)0, E_CONFIG_DATA_TYPE_INT },
    {"wifi/gpio_wifi_enable", (unsigned int)10, E_CONFIG_DATA_TYPE_INT },
    {"wifi/gpio_wifi_irq", (unsigned int)4, E_CONFIG_DATA_TYPE_INT },
    {"wifi/nvram", (const unsigned int)(unsigned int*)"nvram_H30_TL", E_CONFIG_DATA_TYPE_STRING },
    {"wifi/wifi_clock", (unsigned int)50000000, E_CONFIG_DATA_TYPE_INT },
    {0, 0, 0}
 };
struct board_id_general_struct config_common_H30_L01_VA= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_H30_L01_VA,
 .data_array={.config_pair_ptr=hw_H30_L01_VA_configs},
 .list={NULL,NULL},
};
