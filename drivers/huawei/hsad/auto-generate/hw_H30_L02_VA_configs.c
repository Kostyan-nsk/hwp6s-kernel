...
config_pair  hw_H30_L02_VA_configs [] = {
    ...
    {"board/board_name", (const unsigned int)(unsigned int*)"H30_L02_VA", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"product/name", (const unsigned int)(unsigned int*)"H30_L02_VA", E_CONFIG_DATA_TYPE_STRING },
...
struct board_id_general_struct config_common_H30_L02_VA= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_H30_L02_VA,
 .data_array={.config_pair_ptr=hw_H30_L02_VA_configs},
 .list={NULL,NULL},
};
