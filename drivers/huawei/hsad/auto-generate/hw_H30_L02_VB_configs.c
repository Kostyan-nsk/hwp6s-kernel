...
config_pair  hw_H30_L02_VB_configs [] = {
    {"apds/apds_type", (unsigned int)9, E_CONFIG_DATA_TYPE_INT },
    {"atmel/slave_address", (unsigned int)51, E_CONFIG_DATA_TYPE_INT },
    {"audio/aud_para", (const unsigned int)(unsigned int*)"HONORUL", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"board/board_name", (const unsigned int)(unsigned int*)"H30_L02_VB", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"product/name", (const unsigned int)(unsigned int*)"H30_L02_VB", E_CONFIG_DATA_TYPE_STRING },
    {"product/product_name", (const unsigned int)(unsigned int*)"H30_L02", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"wifi/nvram", (const unsigned int)(unsigned int*)"nvram_H30_UL", E_CONFIG_DATA_TYPE_STRING },
    {"wifi/wifi_clock", (unsigned int)50000000, E_CONFIG_DATA_TYPE_INT },
    {0, 0, 0}
 };
struct board_id_general_struct config_common_H30_L02_VB= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_H30_L02_VB,
 .data_array={.config_pair_ptr=hw_H30_L02_VB_configs},
 .list={NULL,NULL},
};
