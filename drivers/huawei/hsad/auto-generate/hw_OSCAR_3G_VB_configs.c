...
config_pair  hw_OSCAR_3G_VB_configs [] = {
    ...
    {"board/board_name", (const unsigned int)(unsigned int*)"OSCAR_3G_VB", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"cdma_gsm/boardid_virtual", (unsigned int)1, E_CONFIG_DATA_TYPE_INT },
    {"cdma_gsm/cdma_select", (unsigned int)1, E_CONFIG_DATA_TYPE_INT },
    {"cdma_gsm/cg_mode", (unsigned int)0, E_CONFIG_DATA_TYPE_INT },
    ...
    {"memory_config/gralloc", (unsigned int)254976, E_CONFIG_DATA_TYPE_INT },
    ...
    {"nfc/name_conf", (const unsigned int)(unsigned int*)"oscar", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"product/name", (const unsigned int)(unsigned int*)"OSCAR_3G_VB", E_CONFIG_DATA_TYPE_STRING },
    {"product/product_name", (const unsigned int)(unsigned int*)"OSCAR_3G", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"wifi/nvram", (const unsigned int)(unsigned int*)"nvram_OSCAR_3G", E_CONFIG_DATA_TYPE_STRING },
    {"wifi/wifi_clock", (unsigned int)50000000, E_CONFIG_DATA_TYPE_INT },
    {0, 0, 0}
 };
struct board_id_general_struct config_common_OSCAR_3G_VB= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_OSCAR_3G_VB,
 .data_array={.config_pair_ptr=hw_OSCAR_3G_VB_configs},
 .list={NULL,NULL},
};
