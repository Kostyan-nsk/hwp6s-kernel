...
config_pair  hw_OSCAR_VUL_VC_configs [] = {
...
struct board_id_general_struct config_common_OSCAR_VUL_VC= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_OSCAR_VUL_VC,
 .data_array={.config_pair_ptr=hw_OSCAR_VUL_VC_configs},
 .list={NULL,NULL},
};
