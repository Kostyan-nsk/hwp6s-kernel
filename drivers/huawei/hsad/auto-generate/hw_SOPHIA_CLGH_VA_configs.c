...
config_pair  hw_SOPHIA_CLGH_VA_configs [] = {
    ...
    {"board/board_name", (const unsigned int)(unsigned int*)"SOPHIA_CLGH_VA", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"lcd/cabc_enable", (unsigned int)1, E_CONFIG_DATA_TYPE_INT },
    {"lcd/devices", (const unsigned int)(unsigned int*)"mipi_jdi_OTM1902B", E_CONFIG_DATA_TYPE_STRING },
    {"lcd/full_range_bl_enable", (unsigned int)1, E_CONFIG_DATA_TYPE_INT },
    ...
    {"product/name", (const unsigned int)(unsigned int*)"SOPHIA_CLGH_VA", E_CONFIG_DATA_TYPE_STRING },
...
struct board_id_general_struct config_common_SOPHIA_CLGH_VA= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_SOPHIA_CLGH_VA,
 .data_array={.config_pair_ptr=hw_SOPHIA_CLGH_VA_configs},
 .list={NULL,NULL},
};
