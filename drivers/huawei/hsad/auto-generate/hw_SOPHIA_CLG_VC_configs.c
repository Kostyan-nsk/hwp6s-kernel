...
config_pair  hw_SOPHIA_CLG_VC_configs [] = {
    ...
    {"board/board_name", (const unsigned int)(unsigned int*)"SOPHIA_CLG_VC", E_CONFIG_DATA_TYPE_STRING },
...
struct board_id_general_struct config_common_SOPHIA_CLG_VC= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_SOPHIA_CLG_VC,
 .data_array={.config_pair_ptr=hw_SOPHIA_CLG_VC_configs},
 .list={NULL,NULL},
};
