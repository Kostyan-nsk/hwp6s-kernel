...
config_pair  hw_SOPHIA_ULGH_VA_configs [] = {
    ...
    {"audio/comph_val", (unsigned int)134, E_CONFIG_DATA_TYPE_INT },
    ...
    {"board/board_name", (const unsigned int)(unsigned int*)"SOPHIA_ULGH_VA", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"memory_config/codec", (unsigned int)65536, E_CONFIG_DATA_TYPE_INT },
    {"memory_config/fb", (unsigned int)24300, E_CONFIG_DATA_TYPE_INT },
    {"memory_config/gpu", (unsigned int)1024, E_CONFIG_DATA_TYPE_INT },
    {"memory_config/gralloc", (unsigned int)204800, E_CONFIG_DATA_TYPE_INT },
    {"memory_config/overlay", (unsigned int)4, E_CONFIG_DATA_TYPE_INT },
    ...
    {"nfc/name_conf", (const unsigned int)(unsigned int*)"sophia_h", E_CONFIG_DATA_TYPE_STRING },
    {"nfc/nfc_card_num", (unsigned int)1, E_CONFIG_DATA_TYPE_INT },
    {"nfc/nfc_chip_type", (const unsigned int)(unsigned int*)"pn547", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"product/name", (const unsigned int)(unsigned int*)"SOPHIA_ULGH_VA", E_CONFIG_DATA_TYPE_STRING },
    {"product/product_name", (const unsigned int)(unsigned int*)"SOPHIA_ULGH", E_CONFIG_DATA_TYPE_STRING },
...
struct board_id_general_struct config_common_SOPHIA_ULGH_VA= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_SOPHIA_ULGH_VA,
 .data_array={.config_pair_ptr=hw_SOPHIA_ULGH_VA_configs},
 .list={NULL,NULL},
};
