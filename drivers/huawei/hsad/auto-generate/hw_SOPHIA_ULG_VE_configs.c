...
config_pair  hw_SOPHIA_ULG_VE_configs [] = {
    ...
    {"board/board_name", (const unsigned int)(unsigned int*)"SOPHIA_ULG_VE", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"product/name", (const unsigned int)(unsigned int*)"SOPHIA_ULG_VE", E_CONFIG_DATA_TYPE_STRING },
...
struct board_id_general_struct config_common_SOPHIA_ULG_VE= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_SOPHIA_ULG_VE,
 .data_array={.config_pair_ptr=hw_SOPHIA_ULG_VE_configs},
 .list={NULL,NULL},
};
