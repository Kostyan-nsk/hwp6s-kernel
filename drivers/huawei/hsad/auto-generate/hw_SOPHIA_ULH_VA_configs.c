...
config_pair  hw_SOPHIA_ULH_VA_configs [] = {
    ...
    {"board/board_name", (const unsigned int)(unsigned int*)"SOPHIA_ULH_VA", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"nfc/name_conf", (const unsigned int)(unsigned int*)"default", E_CONFIG_DATA_TYPE_STRING },
    ...
    {"product/name", (const unsigned int)(unsigned int*)"SOPHIA_ULH_VA", E_CONFIG_DATA_TYPE_STRING },
...
struct board_id_general_struct config_common_SOPHIA_ULH_VA= {
 .name=COMMON_MODULE_NAME,
 .board_id=BOARD_ID_SOPHIA_ULH_VA,
 .data_array={.config_pair_ptr=hw_SOPHIA_ULH_VA_configs},
 .list={NULL,NULL},
};
