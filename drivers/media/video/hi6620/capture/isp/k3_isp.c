...
#define ISP_DDR2_BLOCK_PROFILE                  CONFIG_ISP_DDR2_BLOCK_PROFILE
#endif
...
#ifndef ISP_DDR2_BLOCK_PROFILE
#define ISP_DDR2_BLOCK_PROFILE                  (533000)
#endif

#define ISP_DDR_MIN_PROFILE_PREVIEW (533000)
#define ISP_DDR_MIN_PROFILE_CAPTURE (800000)
#define ISP_DDR2_MIN_PROFILE_CAPTURE (533000)
                            ...
                            u32             zoom_view_center_y)
{
	...
	if (ret) {
			print_error("k3_isp_yuvrect_to_rawrect2() error");
			return ret;
	}
