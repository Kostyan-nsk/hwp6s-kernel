		     ...
		     enum v4l2_buf_type buf_type, camera_state state,mini_buffer_arr_t *buf_arr)
{
	...
	if (state == STATE_PREVIEW) {
		...
		//add for zoom expo
		if(isp_data.zoom_ext.zoom ==0)
				camera_agent_set_DIGTIALZOOMLEVEL(0,0,0,0,isp_data.sensor->sensor_index);
		else
				camera_agent_set_DIGTIALZOOMLEVEL(isp_data.pic_attr[STATE_PREVIEW].crop_x,
																		isp_data.pic_attr[STATE_PREVIEW].crop_y,
																		isp_data.pic_attr[STATE_PREVIEW].crop_width,
																		isp_data.pic_attr[STATE_PREVIEW].crop_height,
																		isp_data.sensor->sensor_index);
