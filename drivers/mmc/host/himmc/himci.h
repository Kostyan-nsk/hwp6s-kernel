...
#define SDMMC_3V3_IO_LDO7_SSI_VALUE          (0x3)
#define SDMMC_1V8_IO_LDO7_SSI_VALUE	     (0x0)
#define SDMMC_DR1_ISET_SSI_VALUE	     (0x7)
#define SDMMC_DR2_ISET_SSI_VALUE	     (0x7)
#define SDMMC_DR_CONTROL_SSI_VALUE	     (0x11)
