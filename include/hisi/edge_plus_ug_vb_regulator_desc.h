 ...
 ******************************************************************************
  ...
  文 件 名   : edge_plus_ug_vb_regulator_desc.h
  生成日期   : 2015年1月6日
  
******************************************************************************/


#ifndef __EDGE_PLUS_UG_VB_REGULATOR_DESC_H__
#define __EDGE_PLUS_UG_VB_REGULATOR_DESC_H__
...
static struct regulator_desc regulators_edge_plus_ug_vb[] = {
    [BUCK1_ID] = {
        .name = BUCK1_NAME,
        .id = BUCK1_ID,
