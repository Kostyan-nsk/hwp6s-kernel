 ...
 ******************************************************************************
  ...
  文 件 名   : h30_l12_va_regulator_desc.h
  生成日期   : 2015年1月6日
  
******************************************************************************/


#ifndef __H30_L12_VA_REGULATOR_DESC_H__
#define __H30_L12_VA_REGULATOR_DESC_H__
...
static struct regulator_desc regulators_h30_l12_va[] = {
    [BUCK1_ID] = {
        .name = BUCK1_NAME,
        .id = BUCK1_ID,
