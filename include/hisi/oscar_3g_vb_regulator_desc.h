 ...
 ******************************************************************************
  ...
  文 件 名   : oscar_3g_vb_regulator_desc.h
  生成日期   : 2015年1月6日
  
******************************************************************************/


#ifndef __OSCAR_3G_VB_REGULATOR_DESC_H__
#define __OSCAR_3G_VB_REGULATOR_DESC_H__
...
static struct regulator_desc regulators_oscar_3g_vb[] = {
    [BUCK1_ID] = {
        .name = BUCK1_NAME,
        .id = BUCK1_ID,
