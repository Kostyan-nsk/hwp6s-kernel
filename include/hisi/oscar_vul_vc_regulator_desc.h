 ...
 ******************************************************************************
  ...
  文 件 名   : oscar_vul_vc_regulator_desc.h
  生成日期   : 2015年1月6日
  
******************************************************************************/


#ifndef __OSCAR_VUL_VC_REGULATOR_DESC_H__
#define __OSCAR_VUL_VC_REGULATOR_DESC_H__
...
static struct regulator_desc regulators_oscar_vul_vc[] = {
    [BUCK1_ID] = {
        .name = BUCK1_NAME,
        .id = BUCK1_ID,
