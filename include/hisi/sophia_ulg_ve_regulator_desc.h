 ...
 ******************************************************************************
  ...
  文 件 名   : sophia_ulg_ve_regulator_desc.h
  生成日期   : 2015年1月6日
  
******************************************************************************/


#ifndef __SOPHIA_ULG_VE_REGULATOR_DESC_H__
#define __SOPHIA_ULG_VE_REGULATOR_DESC_H__
...
static struct regulator_desc regulators_sophia_ulg_ve[] = {
    [BUCK1_ID] = {
        .name = BUCK1_NAME,
        .id = BUCK1_ID,
