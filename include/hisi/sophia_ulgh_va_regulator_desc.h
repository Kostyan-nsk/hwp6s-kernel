 ...
 ******************************************************************************
  ...
  文 件 名   : sophia_ulgh_va_regulator_desc.h
  生成日期   : 2015年1月6日
  
******************************************************************************/


#ifndef __SOPHIA_ULGH_VA_REGULATOR_DESC_H__
#define __SOPHIA_ULGH_VA_REGULATOR_DESC_H__
...
static struct regulator_desc regulators_sophia_ulgh_va[] = {
    [BUCK1_ID] = {
        .name = BUCK1_NAME,
        .id = BUCK1_ID,
