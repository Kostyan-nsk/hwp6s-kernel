...
/* splash2 -> /dev/block/mmcblk0p20 */
#define LOG_PARTITION_DEV "mmcblk0p20"
/* /sys/devices/platform/hi_mci.0/mmc_host/mmc0/mmc0:0006/block/mmcblk0/mmcblk0p20 */
#define LOG_PARTITION_START 0x68000
